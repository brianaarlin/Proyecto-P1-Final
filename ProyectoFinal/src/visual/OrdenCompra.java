...
public class OrdenCompra extends JDialog {
	...
	public OrdenCompra() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(OrdenCompra.class.getResource("/iconos/lip.png")));
		...
		}
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				btnSeleccionar.setIcon(new ImageIcon(OrdenCompra.class.getResource("/iconos/select.png")));
			...
			}
			{
				...
				cancelButton.setIcon(new ImageIcon(OrdenCompra.class.getResource("/iconos/cancel.png")));
